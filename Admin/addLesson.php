...
if(isset($_REQUEST['lessonSubmitBtn'])){
    ...
    else
    {
        ...
        $sql = "INSERT INTO tblLesson (LessonName,LessonDescription, LessonLink, CourseId ,CourseName) VALUES
         ('$lesson_name', '$lesson_desc', '$link_folder', '$course_id','$course_name')";

        if($conn->query($sql)== TRUE){
            // below msg display on form submit success
            $msg= '<div class="alert alert-success" role="alert">
            Lesson Added Succesfully!
            </div> ';
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="course_desc">Lesson Name</label>
